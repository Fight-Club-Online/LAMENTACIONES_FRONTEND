...
export const FightResultScreen: React.FC<Props> = ({ result, gameState, userId }) => {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center w-full max-w-lg animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <button
                    ...
                    className="bg-white text-black font-black text-[13px] tracking-[.2em] uppercase px-10 py-4 rounded-xl hover:opacity-85 active:scale-95 transition-all mb-6"
                >
                    Volver al lobby
                </button>
