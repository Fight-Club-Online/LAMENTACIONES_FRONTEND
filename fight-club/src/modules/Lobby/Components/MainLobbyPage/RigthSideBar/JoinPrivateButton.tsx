    ...
    return (
        <>
            <button 
                ...
                className="group relative flex items-center justify-between p-6 bg-surface-container-high hover:bg-surface-container-highest transition-all duration-200 active:scale-[0.98] border-l-0 hover:border-l-[6px] border-primary-container shadow-xl overflow-hidden rounded-[18px] cursor-pointer"
            >
                <div className="flex flex-col items-start z-10 text-left">
                    ...
                    <span className="text-[10px] text-stone-500 font-body mt-1 uppercase tracking-widest">Entra a una sala privada con su código</span>
                </div>
